...
class PrivateVanTourController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->success(
            ...
            'private vantour discount retrieved'
        );
    }
    ...
    public function store(Request $request)
    {
        ...
        $setting = Setting::updateOrCreate(
            ['meta_key' => Setting::PRIVATE_VAN_TOUR_DISCOUNT],
            ['meta_value' => (string) $validated['meta_value']]
        );

        return $this->success(
            $this->format($setting),
            'private vantour discount saved',
            201
        );
    }
    ...
    public function update(Request $request, $id = null)
    {
        ...
        return $this->success(
            $this->format($setting),
            'private vantour discount updated',
            200
        );
    }
    ...
    public function destroy($id = null)
    {
        ...
        return $this->success(
            null,
            'private vantour discount deleted',
            200
        );
    }
