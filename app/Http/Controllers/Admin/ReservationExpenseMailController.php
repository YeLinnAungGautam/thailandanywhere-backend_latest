...
use App\Models\ReservationExpenseMail;
use App\Traits\HttpResponses;
use App\Traits\ImageManager;
use Exception;
use Illuminate\Http\Request;

class ReservationExpenseMailController extends Controller
{
    use ImageManager;
    use HttpResponses;
        ...
        try {
            ...
            if ($request->hasFile('files')) {
                foreach ($request->file('files') as $file) {
                    ...
                    $requestProve = new ReservationExpenseMail([
    ...
    {
        try {
            $passport = ReservationExpenseMail::find($id);
