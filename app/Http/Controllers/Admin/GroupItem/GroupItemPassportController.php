...
class GroupItemPassportController extends Controller
{
    use HttpResponses;

    protected $document_type_validation_rule = 'required|in:passport,tax_slip,paid_slip,receipt_image,booking_confirm_letter,confirmation_letter,car_photo';
