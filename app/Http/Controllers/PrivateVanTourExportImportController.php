...
use App\Imports\PrivateVanTourImport;
use App\Traits\HttpResponses;
use Exception;
use Illuminate\Http\Request;

class PrivateVanTourExportImportController extends Controller
{
    use HttpResponses;
    ...
    public function export()
    {
        try {
            ...
            \Excel::store(new PrivateVantourExport, "export/" . $file_name);
    ...
    public function import(Request $request)
    {
        try {
            ...
            \Excel::import(new PrivateVanTourImport, $request->file('file'));
