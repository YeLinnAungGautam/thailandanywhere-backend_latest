...
class InclusiveProductListResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'details' => InclusiveDetailListResource::collection($this->InclusiveDetails),

            // 'pdfs' => InclusivePdfResource::collection($this->pdfs),
