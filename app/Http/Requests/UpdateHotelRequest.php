...
class UpdateHotelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|in:direct_booking,other_booking',
            ...
            'nearby_places.*.image' => 'nullable',
            'category_id' => 'nullable|exists:categories,id',
            'vat_inclusion' => 'sometimes|required|boolean',
            'contracts' => 'nullable|array',
            'contracts.*' => 'file|mimes:pdf,doc,docx,jpg,jpeg,png|max:10240',
