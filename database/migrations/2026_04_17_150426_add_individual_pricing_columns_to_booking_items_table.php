...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('booking_items', function (Blueprint $table) {
            ...
            $table->decimal('child_price', 10, 2)->nullable()->after('selling_price');
            $table->decimal('child_cost', 10, 2)->nullable()->after('cost_price');
            $table->decimal('child_total_selling_price', 10, 2)->nullable()->after('selling_price');
            $table->decimal('child_total_cost', 10, 2)->nullable()->after('cost_price');
            $table->integer('child_quantity')->nullable()->after('quantity');
